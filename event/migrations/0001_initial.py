# Generated by Django 3.2.7 on 2023-05-17 01:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Validated', 'Validated'), ('Not validated yet', 'Not validated yet'), ('Waiting for validation', 'Waiting for validation'), ('Rejected', 'Rejected')], default='Not validated yet', max_length=50)),
                ('signed_file', models.FileField(blank=True, null=True, upload_to='pdfs/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surat_tugas', models.FileField(blank=True, null=True, upload_to='pdfs/')),
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='account.account')),
