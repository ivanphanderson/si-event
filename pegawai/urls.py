...
from .views import AddPegawaiView, SavePegawaiToDatabase, DisplayPegawaiView, UpdatePegawaiView, SaveUpdatePegawai
...
urlpatterns = [
    ...
    path('save-update-pegawai/', SaveUpdatePegawai.as_view(), name='save_update_pegawai')
]
